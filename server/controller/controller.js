...
// retrieve and return all users / retrive and return a sigle user
exports.find = (req, res) => {
    ...
    if(req.query.id){
        ...
        Userdb.find().then(user =>{
            ...
            res.status(500).send({
                message: err.message || "Error occured while retriving the user"
            });
        });
    }
}
...
exports.delete = (req, res) => {
    ...
    Userdb.findByIdAndDelete(id).then(data =>{
        ...
        res.status(500).send({message: `Cannot delete user with id:${id}. User not found`});
    });
}
